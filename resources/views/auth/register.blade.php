        ...
        <div class="hidden lg:flex flex-col text-left pr-10">
            ...
            <ul class="space-y-6">
                <li class="flex items-start gap-4">
                    ...
                    <div><h4 class="font-bold">Akses Terpusat</h4><p class="text-sm text-slate-500 dark:text-slate-400">Temukan semua kebutuhan akademik Anda di satu pintu.</p></div>
                </li>
                <li class="flex items-start gap-4">
                    ...
                    <div><h4 class="font-bold">Mudah Digunakan</h4><p class="text-sm text-slate-500 dark:text-slate-400">Interface yang intuitif</p></div>
                </li>
                <li class="flex items-start gap-4">
                    ...
                    <div><h4 class="font-bold">Selalu Update</h4><p class="text-sm text-slate-500 dark:text-slate-400">Layanan terbaru tersedia</p></div>
                </li>
            </ul>
        </div>
            ...
            <form action="#" method="POST">
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" class="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none smooth-transition" placeholder="Pilih username">
                    </div>
                </div>
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" class="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none smooth-transition" placeholder="Minimal 6 karakter">
                    </div>
                </div>
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" class="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none smooth-transition" placeholder="Ulangi password">
                    </div>
                </div>
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <select class="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none appearance-none smooth-transition">
